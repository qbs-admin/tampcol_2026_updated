package com.qbrains.tampcolapp.ui.OtpEditText
    ...
    private fun init(
        ...
        if (!isInEditMode) {
            ...
            context.theme.resolveAttribute(
                `in`.aabhasjindal.otptextview.R.attr.colorControlActivated,
                outValue, true
            )
            val colorActivated = outValue.data
            mColors[0] = colorActivated
            context.theme.resolveAttribute(
                `in`.aabhasjindal.otptextview.R.attr.colorPrimaryDark,
                outValue, true
            )
            val colorDark = outValue.data
            mColors[1] = colorDark
            context.theme.resolveAttribute(
                `in`.aabhasjindal.otptextview.R.attr.colorControlHighlight,
                outValue, true
            )
